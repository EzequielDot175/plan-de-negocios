...
class canvasHelpers {
	...
	drawStrokeCircle(x, y, r,c){
		this.ctx.save();
		this.ctx.beginPath();
		this.ctx.lineWidth = 1.5;
		this.ctx.strokeStyle = c || "#000000";
		this.ctx.arc(x, y, r, 0, 2 * Math.PI, false);
		this.ctx.closePath();
		this.ctx.stroke();
		this.ctx.restore();
...
class veCanvas extends canvasHelpers{
	...
	_DrawReferences(){
		...
		this.drawCircle(x + 10, y, 10,"rgba(91,91,91,0.3)");
		this.drawCircle(x + 100, y, 10,"rgba(204,150,0,0.3)");
		this.drawStrokeCircle(x + 10, y, 10,"rgba(91,91,91,0.6)");
		this.drawStrokeCircle(x + 100, y, 10,"#CC9600");
		this.drawText(x + 30,this.workspace.paddingBottom - 50,"AVANCE",11,null,"#666666");
		this.drawText(x + 120 ,this.workspace.paddingBottom - 50,"OBJETIVO",11,null,"#666666");
	}
	...
	_DrawMax(){
		...
		var maxYColumn = this.columnProperties.maxWorkCol - 1;

		var widthContent = 50;

		console.info('Reporting coordinates:', this.coordinates.columns.y[maxYColumn] );

		this.ctx.beginPath();
		this.ctx.moveTo(x + 24, this.y(this.workspace.paddingBottom + this.coordinates.columns.y[maxYColumn]));
		this.ctx.strokeStyle  = "#434343";
		this.ctx.lineTo(x + 24, this.y(this.workspace.paddingBottom));
		this.ctx.closePath();
		this.ctx.stroke();
		...
		// 	x + 24,
		// 	this.coordinates.columns.y[maxYColumn]
		// );
		...
		var perc = this.pointers.total[this.info.lastColumnCharged - 1].perc+"%";
...
//		console.info('Reporting MathAng:', );
	...
	_WorkSpace(){
		...
		this._DrawLinePoints("total","rgba(204,150,0,0.5)");
